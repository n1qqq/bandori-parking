export default {
  title: "Bandori Parking Calculator",
  lb_cli: "CLI Input",
  lb_mode: "Event Mode",
  lb_boost: "Event Boost (%)",
  lb_fire: "LB (Live Boost)",
  lb_num: "Num Parameter",
  lb_medley: "Medley LB",
  lb_team: "Team Score (check this if winning team live fes)",
  lb_calculate: "Target Event Points (--calculate param)",
  run: "Calculate!",
  lb_output: "Outcome",

  ph_cli: "type bandori-parking --? for helper doc",
  ph_boost: "usually 0 ~ 376",
  ph_num: "support band power / ranking (or score) / medley streak (or score)",
  ph_medley: "e.g. 1,0,3",
  ph_calculate: "required",
